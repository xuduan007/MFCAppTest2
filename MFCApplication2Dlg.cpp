...
CMFCApplication2Dlg::~CMFCApplication2Dlg()
{
	...
	{
		if (m_pModelessDlg->m_hWnd != nullptr)
		{
...
BEGIN_MESSAGE_MAP(CMFCApplication2Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_MODAL_BTN, &CMFCApplication2Dlg::OnBnClickedModalBtn)
	ON_BN_CLICKED(IDC_MODELESS_BTN, &CMFCApplication2Dlg::OnBnClickedModelessBtn)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
{
	// 弹出非模态对话框
	if (m_pModelessDlg == nullptr || m_pModelessDlg->m_hWnd == nullptr)
	{
